...
void YoungMaker7SegmentDisplay::display(char value)
{
    display((int)value);
}

void YoungMaker7SegmentDisplay::display(uint8_t value)
{
    display((int)value);
}

void YoungMaker7SegmentDisplay::display(uint16_t value)
{
    display((int)value);
}

void YoungMaker7SegmentDisplay::display(uint32_t value)
{
    display((int)value);
}

void YoungMaker7SegmentDisplay::display(short value)
{
    display((int)value);
}

void YoungMaker7SegmentDisplay::display(long int value)
{
    display((int)value);
}
